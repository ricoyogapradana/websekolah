    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group col-md-12">
                ...
                <input class="form-control" type="text" value="<?= $gallery->nama_gallery ?>" name="nama_gallery" placeholder="Judul Gallery" required>
            </div>

            <div class="form-group col-md-12">
                <label>Foto Sampul</label><br>
                <img src="<?= base_url('sampul/'.$gallery->sampul) ?>" width="300px" alt="">
            </div>
