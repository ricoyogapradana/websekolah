						...
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title"><a class="home_slider_title" href="<?= base_url('home/detail_berita/'.$value->slug_berita) ?>"><?= substr(strip_tags($value->judul_berita),0,25) ?></a></div>
									<div class="home_slider_subtitle"><?= substr(strip_tags($value->isi_berita),0,200) ?>..</div>
